    ...
    <div class="row g-3">
        <div class="col-12 col-md-4">
            <div class="bg-main p-3 text-center">
                <h3>1,000 SHARD</h3>
                <img src="{{ url('assets/img/topup-shard/shard-1.webp') }}" alt="">
        ...
        <div class="col-12 col-md-4">
            <div class="bg-main p-3 text-center">
                <h3>5,000 SHARD</h3>
                <img src="{{ url('assets/img/topup-shard/shard-2.webp') }}" alt="">
        ...
        <div class="col-12 col-md-4">
            <div class="bg-main p-3 text-center">
                <h3>10,000 SHARD</h3>
                <img src="{{ url('assets/img/topup-shard/shard-3.webp') }}" alt="">
                ...
                <button data-amount="10000" class="w-100 mb-2 btn btn-outline-success btn-topup-idrva">
                    <i class="fas fa-money-bill-wave"></i> IDR 10,000 via BNI VA
                </button>
        ...
        <div class="col-12 col-md-4">
            <div class="bg-main p-3 text-center">
                <h3>25,000 SHARD</h3>
                <img src="{{ url('assets/img/topup-shard/shard-4.webp') }}" alt="">
                ...
                <button data-amount="25000" class="w-100 mb-2 btn btn-outline-success btn-topup-idrva">
                    <i class="fas fa-money-bill-wave"></i> IDR 25,000 via BNI VA
                </button>
        ...
        <div class="col-12 col-md-4">
            <div class="bg-main p-3 text-center">
                <h3>50,000 SHARD</h3>
                <img src="{{ url('assets/img/topup-shard/shard-5.webp') }}" alt="">
                ...
                <button data-amount="50000" class="w-100 mb-2 btn btn-outline-success btn-topup-idrva">
                    <i class="fas fa-money-bill-wave"></i> IDR 50,000 via BNI VA
                </button>
        ...
        <div class="col-12 col-md-4">
            <div class="bg-main p-3 text-center">
                <h3>100,000 SHARD</h3>
                <img src="{{ url('assets/img/topup-shard/shard-6.webp') }}" alt="">
                ...
                <button data-amount="100000" class="w-100 mb-2 btn btn-outline-success btn-topup-idrva">
                    <i class="fas fa-money-bill-wave"></i> IDR 100,000 via BNI VA
                </button>
